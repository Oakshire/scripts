...
function hailed(NPC, Spawn)
	...
	if GetLevel(Spawn) >=7 then
	    PlayFlavor(NPC, "voiceover/english/taneranthalis_nedaiveren/qey_village04/100_park_taneranthalis_multhail2_c2e4d5a7.mp3", "", "", 2103458666, 2948247370, Spawn)
        ...
        AddConversationOption(conversation, "Castleview is a sight to behold, indeed.")
 ...
 function Old(NPC, Spawn)
  ...
  AddConversationOption(conversation, "Unfortunately, I'm busy.")
