...
function hailed(NPC, Spawn)
    if not HasCompletedQuest(Spawn, Water) then
		...
		PlayFlavor(NPC, "voiceover/english/bartender_bulurg/qey_village04/100_bartender_bulurg_multhail2_756404e8.mp3", "I spy that thou might enjoy a taste of mine brews made with real swamp water.  Wouldst this be the case?", "", 1254546536, 617051761, Spawn)
     end
    end
end
    ...
    if not HasQuest (Spawn, Water) then
        ...
        StartConversation(conversation, NPC, Spawn, "I spy that thou might enjoy a taste of mine brews made with real swamp water.  Wouldst this be the case?")
