...
if math.random(1, 100) <= 30 then
    if not HasCompletedQuest (Spawn, Delivery) and not HasQuest (Spawn, Delivery) then         
        choice = math.random(1,2)
            ...
            PlayFlavor(NPC, "voiceover/english/jodi/qey_village03/100_customer_human_jodi_callout_2ca4aa88.mp3", "I hall never make Baubbleshire in time. I need a courier.", "facepalm", 1892112323, 654880852, Spawn)
            end
     else
         choice = math.random(1,2)
            if choice ==1 then
...
function hailed(NPC, Spawn)
	...
	PlayFlavor(NPC, "", "I'm afraid this line hasn't moved in ages!", "sigh", 0, 0, Spawn)
end
