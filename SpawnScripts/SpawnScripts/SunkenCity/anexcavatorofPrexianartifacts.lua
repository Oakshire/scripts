...
function hailed(NPC, Spawn)
	FaceTarget(NPC, Spawn)
        ...
        if choice == 1 then
        PlayFlavor(NPC, "", "These artifacts are very interesting, judging by what i see here...", "", 0, 0, Spawn)
        elseif choice == 2 then
        PlayFlavor(NPC, "", "Perhaps that would explain why this district of the city is plagued with water", "", 0, 0, Spawn)
        else 
        PlayFlavor(NPC, "", "It seems an ancient cult once resided this district", "", 0,0, Spawn)
