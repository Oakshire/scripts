...
function hailed(NPC, Spawn)
	...
	if HasQuest (Spawn, First_ReportingForDuty) then
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/lieutenant_argosian/fprt_adv04_ruins/revamp/lieutenant_argosian001.mp3", "", "no", 1274591844, 2524405313, Spawn)
