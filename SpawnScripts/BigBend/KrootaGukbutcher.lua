...
function Dialog14(NPC, Spawn)
	...
	Dialog.AddOption("Why is this a bad time?", "Dialog8")
...
function Dialog7(NPC, Spawn)
	...
	Dialog.AddOption("What did he do? ", "Dialog20")
	Dialog.Start()
end
...
function Dialog20(NPC, Spawn)
	...
	Dialog.AddOption("Our brethren serve in the army?", "Dialog35")
	Dialog.Start()
end
...
function Dialog17(NPC, Spawn)
	...
	Dialog.AddOption("Your fights praise Rallos?", "Dialog49")
	Dialog.Start()
end
...
function Dialog49(NPC, Spawn)
	...
	Dialog.AddOption("You think we will rise up, once more?", "Dialog48")
	Dialog.Start()
end
...
function Dialog5(NPC, Spawn)
	...
	Dialog.AddOption("What can I do to bring glory to Rallos? ", "Dialog41")
...
function Dialog29(NPC, Spawn)
	...
	Dialog.AddOption("If the fight was so good, then why the temper now? ", "Dialog46")
	Dialog.Start()
end
...
function Dialog46(NPC, Spawn)
	...
	Dialog.AddOption("Trash cleaning is not above me, when it is made worth my while. ", "Dialog9")
...
function Dialog9(NPC, Spawn)
	...
	Dialog.AddOption("Some coin would be useful. ", "Dialog41")
	Dialog.Start()
end
...
function Dialog50(NPC, Spawn)
	...
	Dialog.AddOption("Yes. You said you were gonna' make it worth my while. ", "Dialog4")
	Dialog.Start()
end
...
function Dialog4(NPC, Spawn)
	...
	Dialog.AddOption("What do you need? ", "Dialog3")
...
function Dialog3(NPC, Spawn)
	...
	Dialog.AddOption("What should we do?", "Dialog23")
	Dialog.Start()
end
...
function Dialog39(NPC, Spawn)
	...
	Dialog.AddOption("Oh, good.", "Dialog33")
	Dialog.Start()
end
...
function Dialog19(NPC, Spawn)
	...
	Dialog.AddOption("No.  That Troll woman is demanding silver for it. ", "Dialog11")
	Dialog.Start()
end
...
function Dialog37(NPC, Spawn)
	...
	Dialog.AddOption("That depends on what is expected of me.", "Dialog44")
	Dialog.AddOption("Yes.  My body is Rallos' weapon of destruction.", "Dialog16")
	Dialog.AddOption("No.")
	Dialog.Start()
end
...
function Dialog44(NPC, Spawn)
	...
	Dialog.AddOption("I am worried of my future in Freeport, and do not wish to find trouble with Captain Sorio.", "Dialog18")
	Dialog.Start()
end
...
function Dialog10(NPC, Spawn)
	...
	Dialog.AddOption("What items?", "Dialog1")
	Dialog.Start()
end
...
function Dialog13(NPC, Spawn)
	...
	Dialog.AddOption("I hide no treachery.", "Dialog38")
	Dialog.Start()
end
...
function Dialog45(NPC, Spawn)
	...
	Dialog.AddOption("Is it just you that Lucan's enforcers push around?")
	Dialog.AddOption("Do you have anything else I can do, for some more coin? ")
	Dialog.Start()
end
