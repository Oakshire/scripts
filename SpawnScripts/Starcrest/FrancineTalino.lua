...
function waypoints(NPC)
	...
	MovementLoopAddLocation(NPC, 800.72, -20.47, 287.28, 2, 0)
	MovementLoopAddLocation(NPC, 805.06, -20.4, 284.17, 2, 0)
	MovementLoopAddLocation(NPC, 815.22, -20.34, 273.16, 2, 0)
