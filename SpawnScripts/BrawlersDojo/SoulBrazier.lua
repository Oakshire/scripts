...
function casted_on(NPC, Spawn, SpellName)
  if SpellName == 'Begin Meditation' and not IsInCombat(Spawn)then
      local con = CreateConversation()
        ...
        StartDialogConversation(con, 1, NPC, Spawn, "After proving your combat prowess, you focus on the shrine you noticed words etched into the base.")
...
function Step3(NPC, Spawn)
      local con = CreateConversation()
        ...
        StartDialogConversation(con, 1, NPC, Spawn, "A cool breeze swirls around you, sending a tingle up the back of your spine.  You arise from the altar and know in your soul that you are a brawler.")
