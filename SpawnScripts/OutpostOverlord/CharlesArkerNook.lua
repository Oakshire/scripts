...
function hailed(NPC, Spawn)
    ...
    PlayFlavor(NPC, "voiceover/english/tutorial_revamp/charles_arker/tutorial_island02_evil_revamp/quests/quest_charles_arker/charles_arker015.mp3", "", "", 211277175, 1991489725, Spawn)
    AddConversationOption(conversation, "Except for the pieces I gave you earlier.", "")
...
function dlg_02(NPC, Spawn)
   ...
   AddConversationOption(conversation, "So you killed him?", "dlg_02")
...
function dlg_04(NPC, Spawn)
  ...
  AddConversationOption(conversation, "I'll take care of this.", "dlg_04")
