...
local Goblin2 = SpawnByLocationID(zone, 133775442) --Goblin2
...
local zone = GetZone(NPC)
local Goblin = GetSpawnByLocationID(zone, 133775216) --Goblin1
local Goblin = GetSpawnByLocationID(zone, 133775442) --Goblin2
