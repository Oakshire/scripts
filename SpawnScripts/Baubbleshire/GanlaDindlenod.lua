...
if math.random(1, 100) <= 75 then
    ...
    FaceTarget(NPC, Spawn)
     PlayFlavor(NPC, "", "Oh, if only I could make heads or tails of this book. It must be a a recipe for a fine elven pie! Oh, hello traveler! Could you spare a moment?", "confuse", 0, 0, Spawn)
     else
...
function hailed(NPC, Spawn)
	...
	PlayFlavor(NPC, "voiceover/english/ganla_dindlenod/qey_village06/ganladindlenod000.mp3", "What brings you to the fair vale of Baubbleshire? Seeking a bit of merriment among the stouts?", "hello", 1689589577, 4560189, Spawn)
end
