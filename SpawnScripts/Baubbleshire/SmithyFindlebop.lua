...
function Begin(NPC, Spawn)
	...
	elseif HasQuest(Spawn, MystratTails) and GetQuestStep(Spawn, MystratTails) == 2 then
        ...
        PlayFlavor(NPC, "voiceover/english/smithy_findlebop/qey_village06/100_smithy_findlebop_multhail2_5d0f29cb.mp3", "", "frustrated", 446470782, 3454872230, Spawn)	
