...
function spawn(NPC)
	...
	MovementLoopAddLocation(NPC, 825.03, -13.73, -497.5, 1, 0)
	MovementLoopAddLocation(NPC, 822.44, -17.12, -506.62, 1, 0)
	...
	MovementLoopAddLocation(NPC, 848.14, -18.12, -465.73, 1, 0)
	MovementLoopAddLocation(NPC, 858.82, -18.92, -466.15, 1, 0)
	MovementLoopAddLocation(NPC, 864.6, -19.15, -476.37, 1, 0)
