...
function WoodworkerYes1(NPC, Spawn)
	window = CreateOptionWindow();
	AddOptionWindowOption(window, " Become a Woodworker", "Become proficient in the arts of Woodworking.  You will specialize in making bows, staffs, arrows, shields, and instruments.                     [This can not be undone!]", 0, 628, "WoodworkerYes2")
...
function FinalHail(NPC,Spawn)
	Dialog.AddDialog("Okay. Now you're certified in your chosen tradesman specialty. I'm glad I could help you. We always need skilled tradesman in the city.")
