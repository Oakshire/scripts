--[[
	...
	Script Notes	: VOs added 5.3.2022 - Dorbin
--]]
...
function hailed(NPC, Spawn)
	...
	conversation = CreateConversation()
		...
		PlayFlavor(NPC, "voiceover/english/lookout_venylle/qey_elddar/lookoutvenylle000.mp3", "", "", 487024690, 2845985258, Spawn)
...
function dlg_10_1(NPC, Spawn)
	...
	PlayFlavor(NPC, "voiceover/english/lookout_venylle/qey_elddar/lookoutvenylle001.mp3", "", "", 3608144910, 1097856081, Spawn)
...
function dlg_10_2(NPC, Spawn)
	...
	PlayFlavor(NPC, "voiceover/english/lookout_venylle/qey_elddar/lookoutvenylle002.mp3", "", "", 2384165847, 2428685999, Spawn)
