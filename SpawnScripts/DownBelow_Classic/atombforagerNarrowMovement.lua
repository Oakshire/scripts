...
function RouteOne(NPC, Spawn)
	...
	MovementLoopAddLocation(NPC, X + 2, Y, Z + 2.5, 2, math.random(5,10))
	MovementLoopAddLocation(NPC, X + 2, Y, Z, 2, math.random(5,10))
	MovementLoopAddLocation(NPC, X + 2, Y, Z + 2.5, 2, math.random(5,10))
...
function RouteTwo(NPC, Spawn)
    ...
    MovementLoopAddLocation(NPC, X, Y, Z, 2, 5)
    MovementLoopAddLocation(NPC, X - 2, Y, Z, 2, math.random(5,10))
	MovementLoopAddLocation(NPC, X - 2, Y, Z - 3, 2, math.random(5,10))
	MovementLoopAddLocation(NPC, X - 2, Y, Z, 2, math.random(5,10))
	MovementLoopAddLocation(NPC, X - 2, Y, Z - 3, 2, mmath.random(5,10))
	MovementLoopAddLocation(NPC, X, Y, Z, 2, math.random(5,10), "ChooseMovement")
end
