...
function HumanCosmetics(NPC)
    ...
    local hair = MakeRandomInt(1121,1140) -- f: 1123 (f|m), 1125 (f|m), 1126 (f|m), 1127 (|m), 1129 (f|), 1130 (f|m), 1133 (f|m), 1134 (f|m), 1135 (f|), 1136 (f|)
    ...
    local overall_look = MakeRandomInt(17,17)
        ...
        elseif overall_look == 13 then -- Chestnut and brown skin
        ...
        elseif overall_look == 14 then -- Grey dark
        ...
        elseif overall_look == 15 then -- Black light brown skin
            ...
            SpawnSet(NPC, "hair_highlight", "38 22 21")
            SpawnSet(NPC, "soga_hair_highlight", "38 22 21") 
        elseif overall_look == 16 then -- Brown orange stribes
        ...
        elseif overall_look == 17 then -- Yellow bright white high lights
