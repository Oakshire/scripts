...
--[[	MoveToLocation(NPC, 532.86, -20.72, -295.55, 2, 0)
	...
	MoveToLocation(NPC, 561.72, -21.93, -313.78, 2, 4)
	MoveToLocation(NPC, 556.27, -21.76, -314.34, 2, 0)
	MoveToLocation(NPC, 544.99, -21.16, -326.12, 2, 0)
	MoveToLocation(NPC, 539.46, -20.31, -345.27, 2, 0)
	MoveToLocation(NPC, 540.69, -20.02, -351.6, 2, 4)
	MoveToLocation(NPC, 557.41, -20.46, -356.75, 2, 0)
	MoveToLocation(NPC, 571.4, -21.67, -363.38, 2, 0)
	MoveToLocation(NPC, 574.43, -21.63, -364.45, 2, 0)
	MoveToLocation(NPC, 576.13, -21.63, -364.76, 2, 4)
	MoveToLocation(NPC, 572.51, -21.66, -363.25, 2, 0)
	MoveToLocation(NPC, 554.27, -20.47, -341.45, 2, 0)
	MoveToLocation(NPC, 539.46, -20.96, -329.09, 2, 0)
	MoveToLocation(NPC, 531.08, -21.08, -317.15, 2, 0)
	MoveToLocation(NPC, 525.95, -20.83, -301.52, 2, 0)
	MoveToLocation(NPC, 520.13, -20.69, -288.13, 2, 0)
	MoveToLocation(NPC, 538.59, -20.19, -280.36, 2, 0)
	MoveToLocation(NPC, 549.06, -20.02, -277.42, 2, 0)
	MoveToLocation(NPC, 580.93, -20.83, -259, 2, 0)
	MoveToLocation(NPC, 586.29, -20.75, -257.29, 2, 0)
	MoveToLocation(NPC, 594.39, -21.42, -258.39, 2, 4)
	MoveToLocation(NPC, 584.87, -20.74, -257.79, 2, 0)
	MoveToLocation(NPC, 550.09, -20.03, -277.9, 2, 0)
	MoveToLocation(NPC, 537.85, -20.19, -280.52, 2, 0)
	MoveToLocation(NPC, 520.84, -20.7, -288.93, 2, 4)
