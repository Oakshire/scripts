...
function hailed(NPC, Spawn)
	...
	Dialog.AddDialog("Sorry friend.  You have stepped into an area lost in the fabric of time. Shall I send you to a a more stable timeline?")
...
function OtherReasons(NPC, Spawn)
	...
	FaceTarget(NPC, Spawn)
	Dialog.New(NPC, Spawn)
	Dialog.AddDialog("[This zone is the Revamped (post-LU19) version. Some content here are still a work in progress. The classic zones need testing and offer quest updates not found here.]")
	Dialog.AddOption("Alright. Send me to a stable timeline from here. [Classic Zone]","ClassicZone")
	Dialog.AddOption("Can't you send me somewhere else?","OtherPlace2")
	Dialog.AddOption("Nevermind then. I'm staying here.")
	Dialog.Start()	
