			...
			elseif gender == FEMALE then
				...
				elseif GOOD then
                	...
                	local choice = math.random(1,10)
	                    ...
	                    elseif choice == 5 then
                		PlayFlavor(NPC, "voiceover/english/kerran_eco_good_1/ft/kerran/kerran_eco_good_1_hail_gf_4424ae28.mp3", "How sweet my Tom is to leave such a gift at my doorstep.", "scheme", 206344530, 3671427567, Spawn)
	                    elseif choice == 6 then
	    ...
	    elseif race== ERUDITE then
			if gender == MALE then
			    if EVIL then
				    ...
				    local choice = math.random(1,3)                         
                        if choice == 1 then	
                        PlayFlavor(NPC, "voiceover/english/erudite_eco_race_evil/ft/eco/evil/erudite_eco_race_evil_hail_gm_43bd22f2.mp3", "Greetings.  One day I hope everyone bows before my intellect.", "hello", 3316681960, 3617003101, Spawn)		                elseif choice == 2 then	
                        elseif choice == 2 then	                        
			    	...
			    	local choice = math.random(1,3)
	                    if choice == 1 then --racial check
                            ...
                            PlayFlavor(NPC, "voiceover/english/highelf_eco_race_good/ft/eco/good/highelf_eco_race_good_woodelf_gf_f474672e.mp3", "I see you're on an errand.  Please don't linger.  There is much work to do around here.", "nod", 597450761, 585294431, Spawn)
                                    ...
                                    local check = math.random(1,2) 
	                           	    if check == 1 then
					                PlayFlavor(NPC, "voiceover/english/highelf_eco_race_good/ft/eco/good/highelf_eco_race_good_hail_gf_910f06b6.mp3", "Tunare blesses those who are faithful, and trusts in her return.", "nod", 2463890902, 2461742088, Spawn)
                                    elseif check == 2 then	
