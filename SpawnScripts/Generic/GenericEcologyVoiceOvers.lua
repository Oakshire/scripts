--[[
    ...
    Script Purpose : For City Based/Race Based Voiceover Callouts - Improves Zone ecology/atmosphere. File facilitates ALL generic hails/callouts if they exist. 
               Note: VERIFY YOUR DESIRED RACE/GENDER/FACTION HAS VOs (We are missing many here)
                     THIS FILE IS A LIBRARY OF ALL KNOWN ECOLOGY VOICEOVERS  
...
function hailed(NPC, Spawn)
    FaceTarget(NPC, Spawn)                                                    --MUTED HAIL SINCE THIS FILE IS MEANT TO BE A LIBRARY, NOT A DIRECT FILE CONNECTION TO A SPAWN
	...
	if race >= 0 and race <= 18 and gender >= 1 and gender <= 2 then        -- verifies NPC race/gender fits expected
			...
			elseif gender == FEMALE then                                
			    ...
			    elseif EVIL then
			    	if FPfaction <0 then
			            local choice = math.random(1,2)
				        if choice == 1 then
				        PlayFlavor(NPC, "voiceover/english/barbarian_eco_evil_1/ft/barbarian/barbarian_eco_evil_1_hail_gf_7cbbffe9.mp3", "I wonder how fast you can run with one leg?", "shakefist", 466422573, 1844554045, Spawn)
				        elseif choice == 2 then
				        PlayFlavor(NPC, "", "", "glare", 0, 0, Spawn)
				        end
				    else    
			...
			if gender == MALE then
			    if EVIL then
			    	if FPfaction <0 then
				        ...
				        elseif choice == 2 then
				        PlayFlavor(NPC, "voiceover/english/optional2/human_eco_evil_2/ft/human/human_eco_evil_2_notcitizen_gm_8d2a0876.mp3", "That look's like an awfully expensive pair of boots there... friend.", "point", 367255988, 2113438867, Spawn)
				        end
				    else  			        
                	local choice = math.random(1,13)
                    	...
                    	elseif choice == 10 then
	                    PlayFlavor(NPC, "voiceover/english/human_eco_evil_1/ft/human/human_eco_evil_1_aoi_gm_a2d138b9.mp3", "If you know what's good for ya, you didn't see anything!", "shakefist", 3989425659, 2701948732, Spawn)
                    	elseif choice == 11 then
		...
		elseif race == OGRE then
			if gender == MALE then
			    	if FPfaction <0 then
			            local choice = math.random(1,2)
				        if choice == 1 then
                    	PlayFlavor(NPC, "voiceover/english/ogre_eco_evil_1/ft/ogre/ogre_eco_evil_1_hail_gm_4b96e4f1.mp3", "I've lived this long thanks to my ability to kill.", "shakefist", 1295486986, 820950525, Spawn)
				        elseif choice == 2 then
				        PlayFlavor(NPC, "", "", "glare", 0, 0, Spawn)
				        end
				    else  			    
	    ...
	    elseif gender == FEMALE then
	            if FPfaction <0 then
                    local choice = math.random(1,2)
				        if choice == 1 then
	                    PlayFlavor(NPC, "voiceover/english/ratonga_eco_evil_1/ft/ratonga/ratonga_eco_evil_1_notcitizen_gf_55c7abb4.mp3", "Oh yeah? Whats-why should I?", "glare", 1271306731, 3654197943, Spawn)
				        elseif choice == 2 then	                
		...
		elseif race == WOOD_ELF then
			if gender == MALE then
            	...
            	local choice = math.random(1,13)
	                ...
	                elseif choice == 13 then
	              	PlayFlavor(NPC, "voiceover/english/woodelf_eco_good_1/ft/woodelf/woodelf_eco_good_1_aoi_gm_de3ef6f8.mp3.mp3", "We must calm our emotions through meditation and communion with the spirit of the Eldarr.", "orate", 768027029, 3057323475, Spawn)
			...
			elseif gender == FEMALE then
			    ...
			    elseif EVIL then
			    	if FPfaction <0 then
				        ...
				        PlayFlavor(NPC, "", "", "shakefist", 0, 0, Spawn)
				        elseif choice == 2 then
            		    PlayFlavor(NPC, "voiceover/english/optional2/barbarian_eco_evil_2/ft/barbarian/barbarian_eco_evil_2_hail_gf_56e1abc5.mp3", "Don't worry. The last time I killed someone was a few months ago. I've almost forgot how its done.", "cutthroat", 3295546544, 225622615, Spawn)
				        end
				    else    
	            local choice = math.random(1,4)
			    	...
			    	local choice = math.random(1,3)
	                    if choice == 1 then --racial check
	                        if spawnRace == BARBARIAN then
				                ...
				                local choice = math.random(1,3)     --Calls in Status Praise VO
				                else	                            
	                           	local check = math.random(1,2) 
	                           	    if check == 1 then
                ...
                if gender == MALE then			    	
				    ...
				    local choice = math.random(1,3)                         
                        ...
                        elseif choice == 3 then				        
                            ...
                            elseif spawnRace == OGRE then
					        PlayFlavor(NPC, "voiceover/english/darkelf_eco_race_evil/ft/eco/evil/darkelf_eco_race_evil_ogre_gm_8cf93c6a.mp3", "The Greenmist missed a few spots.  Its a shame the gods were too weak to finish what they started.", "shrug", 181661249, 784055085, Spawn)
                            elseif spawnRace == RATONGA then
	                    	PlayFlavor(NPC, "voiceover/english/darkelf_eco_race_evil/ft/eco/evil/darkelf_eco_race_evil_ratonga_gm_ac7f4092.mp3", "A talking rat?  Ugh, go play with a kerra.", "confused", 396338587, 547395314, Spawn)
			...
			if gender == MALE then
		       if Qfaction < 0 then
                    local choice = math.random(1,2)
				        ...
				        PlayFlavor(NPC, "", "", "sulk", 0, 0, Spawn)
				        elseif choice == 2 then		           
		                PlayFlavor(NPC, "voiceover/english/halfling_eco_good_1/ft/halfling/halfling_eco_good_1_notcitizen_gm_6da83eeb.mp3", "I'll defend myself if it comes to that, savage!", "threaten", 893626909, 4027326251, Spawn)
                        end
                else
			    	local choice = math.random(1,3)
	                    if choice == 1 then --racial check
                            ...
                            elseif spawnRace == HALFLING then
	                            ...
	                            local check = math.random(1,2) 
                                    ...
                                    elseif check == 2 then
					                PlayFlavor(NPC, "voiceover/english/halfling_eco_race_good/ft/eco/good/halfling_eco_race_good_halfling_gm_4a75dace.mp3", "That was some joke you told the other day! I'm still laughing over it!", "chuckle", 1657569571, 2283552256, Spawn)
                                    elseif check == 3 then
				...
				elseif GOOD then
			    	...
			    	local choice = math.random(1,3)
	                    if choice == 1 then
                    	    ...
                    	    PlayFlavor(NPC, "voiceover/english/kerra_eco_race_good/ft/eco/good/kerra_eco_race_good_gnome_gf_5efa2600.mp3", "You make my tail twitch with all your cogs and flizgigs.  Please, keep those away from me.", "agree", 749990561, 792243248, Spawn)
                            elseif spawnRace == HIGH_ELF then
                    	    PlayFlavor(NPC, "voiceover/english/kerra_eco_race_good/ft/eco/good/kerra_eco_race_good_highelf_gf_d5455b09.mp3", "Good leaders bide their time, planning all the while.  I'm sure you already know this.", "agree", 2270743009, 1129155946, Spawn)
		                  else
                            local check = math.random(1,2)
                            if check == 1 then
			...
			elseif gender == FEMALE then
			    	if FPfaction <0 then
                        ...
                        elseif choice == 3 then				        
                            ...
                            elseif spawnRace == ERUDITE then
					        PlayFlavor(NPC, "voiceover/english/ratonga_eco_race_evil/ft/eco/evil/ratonga_eco_race_evil_erudite_gf_38dc60c0.mp3", "Eriuds-things make good brain food!  Haherherh!.", "chuckle", 2399746563, 2249174631, Spawn)
                            elseif spawnRace == HIGH_ELF then
			...
			elseif gender == FEMALE then
			    	...
			    	local choice = math.random(1,3)
	                    if choice == 1 then --racial check
                            ...
                            elseif spawnRace == HALFLING then
					        PlayFlavor(NPC, "", "I miss the woods too, little one.  I miss them too.", "", 0, 0, Spawn)
                            elseif spawnRace == HIGH_ELF then
	...
	if race >= 0 and race <= 18 and gender >= 1 and gender <= 2 then        -- verifies NPC race/gender fits expected
			...
			elseif gender == FEMALE then                                
			    ...
			    elseif EVIL then
			    	if FPfaction <0 then
			            ...
			            local choice = math.random(1,2)
				        if choice == 1 then
				        PlayFlavor(NPC, "voiceover/english/barbarian_eco_evil_1/ft/barbarian/barbarian_eco_evil_1_hail_gf_7cbbffe9.mp3", "I wonder how fast you can run with one leg?", "shakefist", 466422573, 1844554045)
				        elseif choice == 2 then
				        PlayFlavor(NPC, "", "", "glare", 0, 0)
				        end
				      end  
			...
			elseif gender == FEMALE then
				...
				elseif GOOD then
                	...
                	local choice = math.random(1,12)
	                    ...
	                    elseif choice == 6 then
	                    PlayFlavor(NPC, "voiceover/english/erudite_eco_good_1/ft/erudite/erudite_eco_good_1_aoi_gf_ff7f6e34.mp3", "You must be cautious of the draws of evil.  We must master our temptations to preserve our city.", "nod", 4169564254, 3711533067)
	                    elseif choice == 7 then
	                    ...
	                    elseif choice == 11 then
	                    PlayFlavor(NPC, "voiceover/english/erudite_eco_good_1/ft/erudite/erudite_eco_good_1_hail_gf_64055b3d.mp3", "All good things will come to the innocent.", "curstey", 3780206991, 3751425250)
	                    elseif choice == 12 then
             ...
             elseif gender == FEMALE then
                ...
                local choice = math.random(1,9)
                    ...
                    PlayFlavor(NPC, "voiceover/english/froglok_eco_good_1/ft/froglok/froglok_eco_good_1_hail_gf_9ff4f18c.mp3", "Fare thee well, my brave adventurer!  If thou hath any news of our kin, return to Castleview!", "curstey", 2304123366, 1172967267)
   	                elseif choice == 5 then 
                    PlayFlavor(NPC, "voiceover/english/froglok_eco_good_1/ft/froglok/froglok_eco_good_1_hail_gf_a64f6eec.mp3", "What hast thou done?  When one greets a daughter of Marr, a small bow is in order!", "boggle", 2304123366, 1172967267)
   	                elseif choice == 6 then 
			...
			if gender == MALE then
			    if EVIL then
			    	if FPfaction <0 then
				        ...
				        elseif choice == 2 then
				        PlayFlavor(NPC, "voiceover/english/optional2/human_eco_evil_2/ft/human/human_eco_evil_2_notcitizen_gm_8d2a0876.mp3", "That look's like an awfully expensive pair of boots there... friend.", "point", 367255988, 2113438867)
				        end
				        end
				    else
				    if CalloutTimeCheck == false then
			...
			elseif gender == FEMALE then
				...
				elseif GOOD then
	                ...
	                local choice = math.random(1,6)
	                	...
	                	elseif choice == 7 then
	                    PlayFlavor(NPC, "voiceover/english/human_eco_good_1/ft/human/human_eco_good_1_aoi_gf_ffcb538f.mp3", "Qeynos is a bastion of light in the darkness of the land.  I hope you enjoy the sights of the city", "hello", 291039605, 2045457707)
                        elseif choice == 8 then
			...
			if gender == MALE then
			    if EVIL then
			        if FPfaction < 0 then
				        ...
				        PlayFlavor(NPC, "", "", "shakefist", 0, 0)
				        elseif choice == 2 then			            
		                PlayFlavor(NPC, "voiceover/english/kerran_eco_evil_1/ft/kerran/kerran_eco_evil_1_notcitizen_gm_55c7abb4.mp3", "For Thall's sake, what is it?", "glare", 3110431219, 3470484865)
			            end
			            end
			        else
				    if CalloutTimeCheck == false then
		...
		elseif race == OGRE then
			if gender == MALE then
			    	if FPfaction <0 then
			            ...
			            local choice = math.random(1,2)
				        if choice == 1 then
                    	PlayFlavor(NPC, "voiceover/english/ogre_eco_evil_1/ft/ogre/ogre_eco_evil_1_hail_gm_4b96e4f1.mp3", "I've lived this long thanks to my ability to kill.", "shakefist", 1295486986, 820950525)
				        elseif choice == 2 then
				        PlayFlavor(NPC, "", "", "glare", 0, 0)
				        end
				        end
	    ...
	    elseif gender == FEMALE then
	            if FPfaction <0 then
                    ...
                    local choice = math.random(1,2)
				        if choice == 1 then
	                    PlayFlavor(NPC, "voiceover/english/ratonga_eco_evil_1/ft/ratonga/ratonga_eco_evil_1_notcitizen_gf_55c7abb4.mp3", "Oh yeah? Whats-why should I?", "glare", 1271306731, 3654197943)
				        elseif choice == 2 then	                
		...
		elseif race == WOOD_ELF then
			if gender == MALE then
            	...
            	local choice = math.random(1,13)
	                ...
	                elseif choice == 13 then
	              	PlayFlavor(NPC, "voiceover/english/woodelf_eco_good_1/ft/woodelf/woodelf_eco_good_1_aoi_gm_de3ef6f8.mp3.mp3", "We must calm our emotions through meditation and communion with the spirit of the Eldarr.", "orate", 768027029, 3057323475)
			...
			elseif gender == FEMALE then
			    ...
			    elseif EVIL then
			    	if FPfaction <0 then
				        ...
				        PlayFlavor(NPC, "", "", "shakefist", 0, 0)
				        elseif choice == 2 then
            		    PlayFlavor(NPC, "voiceover/english/optional2/barbarian_eco_evil_2/ft/barbarian/barbarian_eco_evil_2_hail_gf_56e1abc5.mp3", "Don't worry. The last time I killed someone was a few months ago. I've almost forgot how its done.", "cutthroat", 3295546544, 225622615)
				        end
				        end
				    else 
				    if CalloutTimeCheck == false then
	                    ...
	                    if choice == 1 then --racial check
	                        if spawnRace == BARBARIAN then
				                ...
				                local choice = math.random(1,3)     --Calls in Status Praise VO
	                           	...
	                           	local check = math.random(1,2) 
                                    ...
                                    elseif check == 2 then
					                PlayFlavor(NPC, "voiceover/english/barbarian_eco_race_good/ft/eco/good/barbarian_eco_race_good_barbarian_gm_e7f2037c.mp3", "Perhaps we should go for a Hallas-cold brew sometime and share stories about our ancestors.", "happy", 2490006983, 800833318)
                                    elseif choice == 3 then	
	                        ...
	                        elseif spawnRace == DWARF then
	                           	local check = math.random(1,2) 
                                    ...
                                    elseif check == 2 then
					                PlayFlavor(NPC, "voiceover/english/barbarian_eco_race_good/ft/eco/good/barbarian_eco_race_good_dwarf_gm_e7f2037c.mp3", "Perhaps we should go for a Hallas-cold brew sometime and share stories about our ancestors.", "happy", 3235630615, 1033414770)
                                    end
                            elseif spawnRace == ERUDITE then
                ...
                if gender == MALE then			    	
				    ...
				    local choice = math.random(1,3)                         
                        ...
                        elseif choice == 3 then				        
                            ...
                            elseif spawnRace == OGRE then
					        PlayFlavor(NPC, "voiceover/english/darkelf_eco_race_evil/ft/eco/evil/darkelf_eco_race_evil_ogre_gm_8cf93c6a.mp3", "The Greenmist missed a few spots.  Its a shame the gods were too weak to finish what they started.", "shrug", 181661249, 784055085)
                            elseif spawnRace == RATONGA then
	                    	PlayFlavor(NPC, "voiceover/english/darkelf_eco_race_evil/ft/eco/evil/darkelf_eco_race_evil_ratonga_gm_ac7f4092.mp3", "A talking rat?  Ugh, go play with a kerra.", "confused", 396338587, 547395314)
                            elseif spawnRace == TROLL then
			...
			if gender == MALE then
		       if Qfaction < 0 then
                    ...
                    local choice = math.random(1,2)
				        ...
				        PlayFlavor(NPC, "", "", "sulk", 0, 0)
				        elseif choice == 2 then		           
		                PlayFlavor(NPC, "voiceover/english/halfling_eco_good_1/ft/halfling/halfling_eco_good_1_notcitizen_gm_6da83eeb.mp3", "I'll defend myself if it comes to that, savage!", "threaten", 893626909, 4027326251)
                    end
                    end
                else
				    if CalloutTimeCheck == false then
	                    ...
	                    if choice == 1 then --racial check
                            ...
                            elseif spawnRace == HALFLING then
	                            ...
	                            local check = math.random(1,2) 
                                    ...
                                    elseif check == 2 then
					                PlayFlavor(NPC, "voiceover/english/halfling_eco_race_good/ft/eco/good/halfling_eco_race_good_halfling_gm_4a75dace.mp3", "That was some joke you told the other day! I'm still laughing over it!", "chuckle", 1657569571, 2283552256)
                                    elseif check == 3 then
			...
			elseif gender == FEMALE then
			    if EVIL then
				    ...
				    if CalloutTimeCheck == false then
                        ...
                        elseif choice == 3 then				        
                            if spawnRace == DARK_ELF then
					        PlayFlavor(NPC, "voiceover/english/human_eco_race_evil/ft/eco/evil/human_eco_race_evil_darkelf_gf_7231fda9.mp3", "You thought you were so superior and look who you come to for protection when things got rough.", "shame", 3384843872, 927025109)
                            elseif spawnRace == ERUDITE then
				...
				elseif GOOD then
			    	...
			    	local choice = math.random(1,3)
	                    if choice == 1 then
                    	    ...
                    	    PlayFlavor(NPC, "voiceover/english/kerra_eco_race_good/ft/eco/good/kerra_eco_race_good_gnome_gf_5efa2600.mp3", "You make my tail twitch with all your cogs and flizgigs.  Please, keep those away from me.", "agree", 749990561, 792243248, Spawn)
                            elseif spawnRace == HIGH_ELF then
                    	    PlayFlavor(NPC, "voiceover/english/kerra_eco_race_good/ft/eco/good/kerra_eco_race_good_highelf_gf_d5455b09.mp3", "????", "sigh", 2270743009, 1129155946, Spawn)
		                  else
                            local check = math.random(1,2)
                            if check == 1 then
		                    PlayFlavor(NPC, "voiceover/english/kerra_eco_race_good/ft/eco/good/kerra_eco_race_good_hail_gf_925a7b74.mp3", "Give me the simplicity of life as the kerra once knew it, and I'll be satisfied.", "", 3093126564, 1574100386, Spawn)
                            elseif check == 2 then
                    	    PlayFlavor(NPC, "voiceover/english/kerra_eco_race_good/ft/eco/good/kerra_eco_race_good_hail_gf_4ae9178a.mp3", "????", "sigh", 261206360, 3555440428, Spawn)
		                    end
		                    end
                        elseif choice == 2 then	
		                PlayFlavor(NPC, "voiceover/english/kerra_eco_race_good/ft/eco/good/kerra_eco_race_good_hail_gf_925a7b74.mp3", "Give me the simplicity of life as the kerra once knew it, and I'll be satisfied.", "", 3093126564, 1574100386, Spawn)
		...
		elseif race == TROLL then
			...
			elseif gender == FEMALE then
				    ...
				    if CalloutTimeCheck == false then
				        ...
				        local choice = math.random(1,3)                         
                        if choice == 1 then	
            		    PlayFlavor(NPC, "voiceover/english/troll_eco_race_evil/ft/eco/evil/troll_eco_race_evil_hail_gf_417aa823.mp3", "Nasty scars and boiled tar.  Warriors is what we are!", "stare", 1257994883, 3501955854)
                        elseif choice == 2 then	                        
                        ...
                        elseif choice == 3 then				        
                            ...
                            elseif spawnRace == ERUDITE then
					        PlayFlavor(NPC, "voiceover/english/ratonga_eco_race_evil/ft/eco/evil/ratonga_eco_race_evil_erudite_gf_38dc60c0.mp3", "Eriuds-things make good brain food!  Haherherh!.", "chuckle", 2399746563, 2249174631)
                            elseif spawnRace == HIGH_ELF then
