...
FaceTarget(NPC, Spawn)
	...
	StartConversation(conversation, NPC, Spawn, "Welcome back, er, Jeenia, was it?  I do appreciate you delivering that letter for me, it's given me time to get my tasks all sorted out and catch up with my local contacts.")
...
function Option9(NPC, Spawn)
	...
	AddConversationOption(conversation, "And I am Jeenia, it's a pleasure to meet you.  So, what needs doing?", "Option10")
