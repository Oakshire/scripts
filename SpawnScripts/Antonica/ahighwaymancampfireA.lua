...
local spawn1 = math.random(0,1)
    if spawn1 == 1 then
local CampSpawn1 = SpawnByLocationID(zone, 133782372) --Highwayman Summoner
    else
    local CampSpawn1a = SpawnByLocationID(zone, 133782379) -- Highwayman Melee
    end   
local spawn2 = math.random(0,1)
    if spawn2 == 1 then
    local CampSpawn2 = SpawnByLocationID(zone, 133782373)--Highwayman Summoner
    else
    local CampSpawn2a = SpawnByLocationID(zone, 133782378)-- Highwayman Melee
    end
local spawn3 = math.random(0,1)
    if spawn3 == 1 then
    local CampSpawn3 = SpawnByLocationID(zone, 133782374)--Highwayman Summoner
    else
    local CampSpawn3a = SpawnByLocationID(zone, 133782377)-- Highwayman Melee
    end   
local spawn4 = math.random(0,1)
    if spawn4 == 1 then
    local CampSpawn4 = SpawnByLocationID(zone, 133782375)--Highwayman Summoner
    else
    local CampSpawn4a = SpawnByLocationID(zone, 133782376)-- Highwayman Melee
    end
...
function CampSpawnCheck_Stage1(NPC, Spawn)  --Stage 1 Living Check
  local zone = GetZone(NPC)
local CampSpawn1 = GetSpawnByLocationID(zone, 133781849)
local CampSpawn1a = GetSpawnByLocationID(zone, 133781843)
local CampSpawn2 = GetSpawnByLocationID(zone, 133781850)
local CampSpawn2a = GetSpawnByLocationID(zone, 133781844)
local CampSpawn3 = GetSpawnByLocationID(zone, 133781851)
local CampSpawn3a = GetSpawnByLocationID(zone, 133781845)
local CampSpawn4 = GetSpawnByLocationID(zone, 133781852)
local CampSpawn4a = GetSpawnByLocationID(zone, 133781846)
...
function Camp_Stage2(NPC, Spawn) --Stage 2 
  local zone = GetZone(NPC)
    local Camp_Stage2Spawn1=SpawnByLocationID(zone, 133782380)--Bloodsaber Agent
...
function CampSpawnCheck_Stage2(NPC, Spawn)  --Stage 2 Living Check
  local zone = GetZone(NPC)
  local Camp_Stage2Spawn1 = GetSpawnByLocationID(zone, 133782380)
...
function Camp_Stage3(NPC, Spawn) --Stage 3 (Possible Boss) 
  ...
  local choice = math.random(0,100)
    ...
    local Camp_Stage3Spawn1=SpawnByLocationID(zone, 133781788)--Bloodsaber Corruptor
    ...
    local CampArkofPower = SpawnByLocationID(zone, 133781841)--Ark of Power
    local CampMerchantSpawn = GetSpawnByLocationID(zone, 589068)--Distressed Merchant
    if CampMerchantSpawn ~=nil then
    Despawn(CampMerchantSpawn)
    local CampGratifiedMerchant = SpawnByLocationID(zone, 133781842)--Gratified Merchant
...
function CampSpawnCheck_Stage3(NPC, Spawn)  --Stage 2 Living Check
  local zone = GetZone(NPC)
  local Camp_Stage3Spawn1 = GetSpawnByLocationID(zone, 133781788) --Blodsaber Corrupter
 if IsAlive(Camp_Stage2Spawn1) == true then
...
local zone = GetZone(NPC)
local CampObject = GetSpawnByLocationID(zone, 170215)   
if CampObject~= nil then
Despawn(CampObject)
    local CampArkofPower = GetSpawnByLocationID(zone, 133781841)--Ark of Power
    if CampArkofPower ~=nil then
    Despawn(CampArkofPower)
    end  
    local CampGratifiedMerchant = GetSpawnByLocationID(zone, 133781842)--Gratified Merchant
