...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 688.42, -20.35, 336.66, 2, 1)
	...
	MovementLoopAddLocation(NPC, 704.45, -23.93, 326.61, 2, 1)
	MovementLoopAddLocation(NPC, 704.45, -23.93, 326.61, 2, 45,"Action")
	MovementLoopAddLocation(NPC, 707.9, -27.18, 341.66, 2, 1)
