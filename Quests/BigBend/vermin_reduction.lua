...
function QuestComplete(Quest, QuestGiver, Player)
	...
	UpdateQuestStepDescription(Quest, 2, "I've spoken with Zarbt.")
	UpdateQuestTaskGroupDescription(Quest, 2, "After all that work I got stiffed on the bill... Lesson learned.")
