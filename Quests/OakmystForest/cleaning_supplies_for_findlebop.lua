...
function Init(Quest)
	AddQuestStepKill(Quest, 1, "I need to find a pristine Mystail rat tail.", 1, 70, "I need to hunt down Mystail matriarch in the Oakmyst forest until I can find a suitable tail.", 172, 1950017)
