...
function Init(Quest)
	...
	AddQuestStepKill(Quest, 2, "I must recover the glowing greenstone rings kept in the strongboxes in Stormhold and bring them to Selwyn.", 8, 100, "I'm almost done with resizing the next piece. If you could do me a favor dear and look for some old druid greenstone rings the Stormhold knights used to keep in their strongboxes that would mean a lot to me. And the things called feign zombies should be on your way to the library. Destroy a few of them just for me, they left me with a nasty bump one time and I like to make them pay for that. - Selwyn", 2931, 2010002,2010013	,2040001)
