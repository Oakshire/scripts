...
function Step1Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I must speak with Tacklemaster Moyna.", 1, "I need to speak with Tacklemaster Moyna about buying a new fishing pole for Brice Strongmend.  She's the first merchant before the docks.", 169, 2350005)
	AddQuestStepCompleteAction(Quest, 2, "QuestComplete")
end

function QuestComplete(Quest, QuestGiver, Player)
	-- The following UpdateQuestStepDescription and UpdateTaskGroupDescription are not needed, parser adds them for completion in case stuff needs to be moved around
	UpdateQuestStepDescription(Quest, 2, "I bought a new fishing pole from Tacklemaster Moyna.")
