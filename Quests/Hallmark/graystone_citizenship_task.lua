...
function Init(Quest)
	AddQuestStepKill(Quest, 1, "Gather five tokens from the creatures in the Oakmyst Forest.", 5, 22, "The local caves have been seeded with tokens for the citizens of the Graystone to gather. These tokens may be found on any creatures in the Oakmyst Forest.", 1333, 0)
