...
function Init(Quest)
	AddQuestStepKill(Quest, 1, "Gather five tokens from the creatures in the Oakmyst Forest.", 5, 22, "The local caves have been seeded with tokens for the citizens of the Castleview to gather. These tokens may be found on any creatures in the Oakmyst Forest.", 1334, 0)
...
function Step1Complete(Quest, QuestGiver, Player)
	...
	UpdateQuestTaskGroupDescription(Quest, 1, "I have gathered the tokens required to prove my worth as a citizen.")
 	AddQuestStep(Quest, 2, "I need to enter the citizenship trial.", 1, "I must perform the citizenship trial by returning to the Citizenship Sign and entering the trial chamber", 1322)
