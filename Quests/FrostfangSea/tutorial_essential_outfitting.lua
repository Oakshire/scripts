...
function Init(Quest)
	...
	AddQuestStepCraft(Quest, 2, "I must create a rawhide backpack using the sewing table.", 1, 100, "I must follow the tutor's instructions to review the crafting process.", 402, 20805)
